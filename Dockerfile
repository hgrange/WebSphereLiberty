...
USER 1001
ENV IBM_JAVA_OPTIONS="-Xshareclasses:name=liberty,readonly,nonfatal,cacheDir=/output/.classCache/ -Dosgi.checkConfiguration=false -XX:+UseContainerSupport"
...
RUN configure.sh && chmod 777 /opt/ibm/wlp/output/defaultServer && ls -la  /opt/ibm/wlp/output/defaultServer
